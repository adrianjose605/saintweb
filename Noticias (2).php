                ...
                <table class="table table-striped table-condensed" >
                    ...
                    <tbody id="tabla">
                        <tr ng-repeat="row in rows" class="centrado">
                            ...
                            <td>
                                <div class="btn-group">
                                    <a class="btn btn-material-red hue-2 btn-xs" href=""  ng-click="getAlerta(row.Opciones)" data-toggle="modal" data-target="#modificar_noticia"><span class="glyphicon glyphicon-search"></span></a>
                                </div>
                            </td>
                        ...
                        <div class="modal-body">
                            <form class="form-inline" name="formNoticiaM" role="form" novalidate>
                                <div class="form-group">
                                    <md-input-container flex>
                                        <label>Usuario</label>
                                        <input ng-model="alerta_nueva.usuario" ng-readonly="true" name="usuario_noticia" type="text">
                                ...
                                <div class="form-group">
                                    <md-input-container flex>
                                        <label>Titulo</label>
                                        <input maxlength="3" ng-model="alerta_nueva.titulo" ng-readonly="true" type="text" name="titulo_noticia">
                                        </md-input-container>
                                </div>
                                   <div class="form-group">
                                    <md-input-container flex>
                                        <label>Detalle</label>
                                        <input ng-model="alerta_nueva.detalle"  ng-readonly="true" name="detalle_noticia" type="text">
